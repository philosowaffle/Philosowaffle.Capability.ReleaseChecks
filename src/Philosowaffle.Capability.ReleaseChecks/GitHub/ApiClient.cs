...
{
	Task<GitHubLatestReleaseResponse> GetLatestReleaseAsync();
}

class ApiClient : IGitHubApiClient
{
	private const string BASE_URL = "https://api.github.com";
	private const string USER = "philosowaffle";
	private const string REPO = "<DockerContainerName>";

	public Task<GitHubLatestReleaseResponse> GetLatestReleaseAsync()
	{
